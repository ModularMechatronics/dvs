#ifndef DVS_MATH_TRANSFORMATIONS_CLASS_DEF_QUATERNION_H_
#define DVS_MATH_TRANSFORMATIONS_CLASS_DEF_QUATERNION_H_
...
#endif // DVS_MATH_TRANSFORMATIONS_CLASS_DEF_QUATERNION_H_
