...
void label_store::get_buffer(float* label_vertices, uint32_t* label_indices,
	uint32_t& label_vertices_count, uint32_t& label_indices_count, std::map<char, Character>& char_atlas)
{
	...
	for (auto& char_s : label_char_list)
	{
		...
		uint32_t t_id = ((label_indices_count / 6) * 4);
		// Triangle 0,1,2
...
void label_store::get_buffer1(float* label_vertices, uint32_t* label_indices,
	uint32_t& label_vertices_count, uint32_t& label_indices_count, std::map<char, Character>& char_atlas)
{
