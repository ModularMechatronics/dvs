...
public:
    RawDataFrame() = delete;
    RawDataFrame(uint8_t* const buffer, const size_t buffer_size, const size_t start_of_frame_idx, const size_t end_of_frame_idx);
...
class BufferedReader
{
    ...
    public:
        ...
        BufferedReader(const RawDataFrame& raw_data_frame) : buffer_{raw_data_frame.data()}, idx_{0U}, size_{raw_data_frame.size()}
        {
        }
