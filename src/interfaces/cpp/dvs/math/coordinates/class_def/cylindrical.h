#ifndef DVS_MATH_COORDINATES_CLASS_DEF_CYLINDRICAL_H_
#define DVS_MATH_COORDINATES_CLASS_DEF_CYLINDRICAL_H_
...
#endif // DVS_MATH_COORDINATES_CLASS_DEF_CYLINDRICAL_H_
