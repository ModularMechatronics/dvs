...
DUOPLOT_WEAK ImageC1 createImageC1(const size_t num_rows, const size_t num_cols, const DataType data_type)
{
    ImageC1 img;
...
DUOPLOT_WEAK ImageC1F toImageC1F(const ImageC1 img)
{
    ImageC1F ret_img = *(ImageC1F*)(&img);
    return ret_img;
}

DUOPLOT_WEAK ImageC1D toImageC1D(const ImageC1 img)
{
    ImageC1D ret_img = *(ImageC1D*)(&img);
    return ret_img;
}

DUOPLOT_WEAK ImageC1S8 toImageC1S8(const ImageC1 img)
{
    ImageC1S8 ret_img = *(ImageC1S8*)(&img);
    return ret_img;
}

DUOPLOT_WEAK ImageC1S16 toImageC1S16(const ImageC1 img)
{
    ImageC1S16 ret_img = *(ImageC1S16*)(&img);
    return ret_img;
}

DUOPLOT_WEAK ImageC1S32 toImageC1S32(const ImageC1 img)
{
    ImageC1S32 ret_img = *(ImageC1S32*)(&img);
    return ret_img;
}

DUOPLOT_WEAK ImageC1S64 toImageC1S64(const ImageC1 img)
{
    ImageC1S64 ret_img = *(ImageC1S64*)(&img);
    return ret_img;
}

DUOPLOT_WEAK ImageC1U8 toImageC1U8(const ImageC1 img)
{
    ImageC1U8 ret_img = *(ImageC1U8*)(&img);
    return ret_img;
}

DUOPLOT_WEAK ImageC1U16 toImageC1U16(const ImageC1 img)
{
    ImageC1U16 ret_img = *(ImageC1U16*)(&img);
    return ret_img;
}

DUOPLOT_WEAK ImageC1U32 toImageC1U32(const ImageC1 img)
{
    ImageC1U32 ret_img = *(ImageC1U32*)(&img);
    return ret_img;
}

DUOPLOT_WEAK ImageC1U64 toImageC1U64(const ImageC1 img)
{
    ImageC1U64 ret_img = *(ImageC1U64*)(&img);
    return ret_img;
}

DUOPLOT_WEAK ImageC3 createImageC3(const size_t num_rows, const size_t num_cols, const DataType data_type)
{
    ImageC3 img;
    img.data_type = data_type;
    img.num_bytes_per_element = duoplot_internal_dataTypeToNumBytes(data_type);
...
DUOPLOT_WEAK ImageC3F toImageC3F(const ImageC3 img)
{
    ImageC3F ret_img = *(ImageC3F*)(&img);
    return ret_img;
}

DUOPLOT_WEAK ImageC3D toImageC3D(const ImageC3 img)
{
    ImageC3D ret_img = *(ImageC3D*)(&img);
    return ret_img;
}

DUOPLOT_WEAK ImageC3S8 toImageC3S8(const ImageC3 img)
{
    ImageC3S8 ret_img = *(ImageC3S8*)(&img);
    return ret_img;
}

DUOPLOT_WEAK ImageC3S16 toImageC3S16(const ImageC3 img)
{
    ImageC3S16 ret_img = *(ImageC3S16*)(&img);
    return ret_img;
}

DUOPLOT_WEAK ImageC3S32 toImageC3S32(const ImageC3 img)
{
    ImageC3S32 ret_img = *(ImageC3S32*)(&img);
    return ret_img;
}

DUOPLOT_WEAK ImageC3S64 toImageC3S64(const ImageC3 img)
{
    ImageC3S64 ret_img = *(ImageC3S64*)(&img);
    return ret_img;
}

DUOPLOT_WEAK ImageC3U8 toImageC3U8(const ImageC3 img)
{
    ImageC3U8 ret_img = *(ImageC3U8*)(&img);
    return ret_img;
}

DUOPLOT_WEAK ImageC3U16 toImageC3U16(const ImageC3 img)
{
    ImageC3U16 ret_img = *(ImageC3U16*)(&img);
    return ret_img;
}

DUOPLOT_WEAK ImageC3U32 toImageC3U32(const ImageC3 img)
{
    ImageC3U32 ret_img = *(ImageC3U32*)(&img);
    return ret_img;
}

DUOPLOT_WEAK ImageC3U64 toImageC3U64(const ImageC3 img)
{
    ImageC3U64 ret_img = *(ImageC3U64*)(&img);
    return ret_img;
}
