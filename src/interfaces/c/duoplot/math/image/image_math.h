...
#define DUOPLOT_AT_IMAGEGRAY_ROW_COL(img, row, col) img.data[row * img.num_cols + col]
#define DUOPLOT_AT_IMAGERGB_COLOR_ROW_COL(img, color, row, col) \
    img.data[color * img.num_rows * img.num_cols + row * img.num_cols + col]

#define DUOPLOT_PRINT_IMAGEGRAY(img, fmt)                                 \
    {                                                                     \
        ...
        {                                                                 \
            ...
            {                                                             \
                printf(fmt, DUOPLOT_AT_IMAGEGRAY_ROW_COL(img, __r, __c)); \
