#ifndef DVS_MATH_TRANSFORMATIONS_CLASS_DEFS_AXIS_ANGLE_CLASS_DEF_H_
#define DVS_MATH_TRANSFORMATIONS_CLASS_DEFS_AXIS_ANGLE_CLASS_DEF_H_
...
#endif // DVS_MATH_TRANSFORMATIONS_CLASS_DEFS_AXIS_ANGLE_CLASS_DEF_H_
